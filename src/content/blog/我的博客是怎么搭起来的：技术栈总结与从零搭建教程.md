...
![博客首页](/image/tutorial-home.png)

文章目录页（「卷册目录」），每篇文章有 FOLIO 编号、日期、分类标签：

![文章目录页](/image/tutorial-blog.png)
...
![管理面板：文章编辑界面，左侧列表、右侧 Markdown 实时预览](/image/tutorial-admin.png)
...
![留言页](/image/tutorial-guestbook.png)
...
![图志页：随文图像 + 独立收藏双档案，按编目卡片排列](/image/tutorial-gallery.png)

![关于页](/image/tutorial-about.png)
